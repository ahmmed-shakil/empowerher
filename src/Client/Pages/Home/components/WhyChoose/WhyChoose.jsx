        ...
        <div className=" pt-10">
          <div className=" grid grid-cols-1 md:grid-cols-2 justify-between  items-center mt-6 ml-0 md:ml-20">
            <div className=" flex items-center gap-3">
              ...
              <p className=" text-lg">
                Experienced tutors with subject-specific expertise
              </p>
            </div>
            <div className=" flex items-center gap-3">
              <svg
            ...
            <div className=" flex items-center gap-3">
              ...
              <p className=" text-lg">
                Customized lesson plans tailored to your individual needs
              </p>
            </div>
            <div className=" flex items-center gap-3">
              <svg
            ...
            <div className=" flex items-center gap-3">
              ...
              <p className=" text-lg">
                24/7 support for all your academic needs
              </p>
            </div>
            <div className=" flex items-center gap-3">
              <svg
              ...
              <p className=" text-lg">
                Secure and user-friendly online tutoring platform
              </p>
            </div>
            <div className=" flex items-center gap-3">
              <svg
